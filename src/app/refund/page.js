        ...
        <div className="bg-gray-800 rounded-lg p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              This Refund Policy outlines when and how we process refunds. We do not offer returns on any product;
              for our return policy please see our <Link href="/return" className="text-blue-400 hover:text-blue-300 underline">Return Policy</Link>.
              Please read this policy carefully before making a purchase.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-blue-400">2. Refund Conditions</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-blue-400">3. Refund Processing</h2>
            <p className="text-gray-300 leading-relaxed mb-2">
              <strong className="text-white">3.1 Method:</strong> Refunds are processed to the original payment
              method used for the purchase (e.g. the same card, UPI, or wallet).
            </p>
            <p className="text-gray-300 leading-relaxed mb-2">
              <strong className="text-white">3.2 Timeline:</strong> Once your claim is approved, we will process
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-blue-400">4. How to Claim a Refund</h2>
            <p className="text-gray-300 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-blue-400">5. Contact for Refund Queries</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-blue-400">6. Changes to This Policy</h2>
            <p className="text-gray-300 leading-relaxed">
              We may update this Refund Policy from time to time. Changes will be effective when posted on this
